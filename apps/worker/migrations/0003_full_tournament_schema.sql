-- Liga Arena full tournament modules schema
-- Ensures schedule, standings, PUBG, MLBB, season, archive and notification tables exist.
-- Safe to apply on an existing D1 database because all objects use IF NOT EXISTS.
